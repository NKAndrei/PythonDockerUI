...
from resources import CreateContainer, GetAllContainers, StopContainer, RemoveContainer, StartContainer, GetContainerProcesses, GetContainerLogs, GetContainerStats, RestartContainer, GetDockerContainerProcessStatus, PullDockerImage, GetAllImages, RemoveDockerImage
...
api.add_resource(RemoveDockerImage, '/removeDockerImage', resource_class_kwargs={'docker_client' : docker_client})
